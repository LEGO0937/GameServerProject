...
void init_DB() {
	...
	std::cout << std::endl << "DB를 성공적으로 불러왔습니다!" << std::endl;
}


int get_DB_Info( int ci ) {
	// Connect to data source  
	retcode = SQLConnect( hdbc, (SQLWCHAR*)L"2015180014_정만", SQL_NTS, (SQLWCHAR*)NULL, 0, NULL, 0 );
...
void set_DB_Info( int ci ) {
	// Connect to data source  
	retcode = SQLConnect( hdbc, (SQLWCHAR*)L"2015080014_game", SQL_NTS, (SQLWCHAR*)NULL, 0, NULL, 0 );
...
void set_DB_Shutdown( int ci ) {
	// Connect to data source  
	retcode = SQLConnect( hdbc, (SQLWCHAR*)L"2015180014_game", SQL_NTS, (SQLWCHAR*)NULL, 0, NULL, 0 );
